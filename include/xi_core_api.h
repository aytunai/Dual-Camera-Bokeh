...
_XI_API_ XI_ERR_TYPE xiInRange_U8(const xi_pArray src, xi_pArray dst, int low, int high);
_XI_API_ XI_ERR_TYPE xiInRange_U8A2(const xi_pArray src, xi_pArray dst, int low, int high);
_XI_API_ XI_ERR_TYPE xiInRange_S16U8(const xi_pArray src, xi_pArray dst, int low, int high);
_XI_API_ XI_ERR_TYPE xiInRange_S16U8A2(const xi_pArray src, xi_pArray dst, int low, int high);
_XI_API_ XI_ERR_TYPE xiInRange_S16U16(const xi_pArray src, xi_pArray dst, int low, int high);
_XI_API_ XI_ERR_TYPE xiInRange_S16U16A(const xi_pArray src, xi_pArray dst, int low, int high);
